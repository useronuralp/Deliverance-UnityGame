        ...
        if(!m_IsInCoroutine)
        {
            ...
            switch (choice)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (CanParry && m_IsIdle) StartCoroutine(DelayedParry(Random.Range(ParryLowerBound, ParryUpperBound))); //You can adjust the parry timing here to increase the difficulty of the AI.
                    break;
                case 4:
